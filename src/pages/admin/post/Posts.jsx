                ...
                <Modal show={openDeleteModal} size="md" onClose={() => setOpenDeleteModal(false)} popup className="z-40">
                    ...
                    <Modal.Body>
                        <div className="text-center">
                            ...
                            <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Bạn có chắc chắn muốn xoá bài đăng này không? Bạn sẽ mất toàn bộ phản hồi và lượt thích!</h3>
