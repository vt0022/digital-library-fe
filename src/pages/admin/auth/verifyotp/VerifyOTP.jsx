...
const VerifyOTP = () => {
        ...
        try {
            ...
            if (response.status === 200) {
                if (type === "register") {
                    ...
                    navigate("/admin/new-password", { state: { email: email } });
                }
            } else {
    ...
    return (
        <>
            <PageHead title="Xác nhận OTP - Admin" description="Xác nhận OTP - learniverse & shariverse" url={window.location.href} origin="both" />
