...
const ForgotPassword = () => {
    ...
    const handleSendEmail = async () => {
        try {
            ...
            if (response.status === 200) {
                ...
                navigate("/manager/verify", { state: { email: email, type: "reset" } });
    ...
    return (
        <>
            <PageHead title="Quên mật khẩu - Quản lý - miniverse" description="Quên mật khẩu - Quản lý - miniverse" url={window.location.href} />
