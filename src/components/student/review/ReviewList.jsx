        ...
        <div className="flex gap-5 mb-5">
            <div className="bg-white rounded-lg shadow-md p-5 w-3/4 h-fit">
                <div>
                    <Rating className="mb-2">
                        ...
                        <p className="ml-2 text-base font-medium">
                            <span className="text-xl">{averageRating}</span> trên 5 <span className="mb-4 text-sm font-medium text-gray-500 dark:text-gray-400">({totalReviews} đánh giá)</span>
                        </p>
                    </Rating>

                    <div className="flex w-full justity-around">
                        <div className="w-1/2 space-y-2">
                            <Rating.Advanced percentFilled={(findCount(5) / totalReviews) * 100}>5 star</Rating.Advanced>
                            <Rating.Advanced percentFilled={(findCount(4) / totalReviews) * 100}>4 star</Rating.Advanced>
                            <Rating.Advanced percentFilled={(findCount(3) / totalReviews) * 100}>3 star</Rating.Advanced>
                            <Rating.Advanced percentFilled={(findCount(2) / totalReviews) * 100}>2 star</Rating.Advanced>
                            <Rating.Advanced percentFilled={(findCount(1) / totalReviews) * 100}>1 star</Rating.Advanced>
                        </div>
                ...
                <div className="grid grid-cols-2 gap-5 mt-8">
                    {reviewList.length === 0 && <p className="text-sm font-medium">Không có đánh giá nào!</p>}
